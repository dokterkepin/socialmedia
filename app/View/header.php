...
<body>
    <!--Navbar-->
    <nav class="navbar navbar-expand-lg mb-5" style="background-color: #F2819B">
        <div class="container-fluid">
            <a class="navbar-brand" style="color: white" href="#">Social Media</a>

            <div class="collapse navbar-collapse navbar-nav me-auto mb-2 mb-lg-0 d-flex flex-row-reverse" id="navbarSupportedContent ">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
